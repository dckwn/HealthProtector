   ...
   <div class="js-viewFrame">
      ...
      <div class="js-viewLeft">
         ...
         <c:forTokens var="fileName" items="${dto.storedFileName }" delims=":">
            <img src="${cpath }/upload/board/${fileName}">
         </c:forTokens>
      </div>
         ...
         <div class="menu">
            <div class="js-item">
               <c:forEach var="reply" items="${replyList}" varStatus="loop">
                  <div class="moreview" style="display: ${loop.index < 5 ? 'block' : 'none'}">
                  ...
                  <div>
                     ...
                     <p>
                        <textarea name="content" placeholder="댓글을 입력 하세요"
                           style="width: 428%; height: 40px; margin: 5px; font-size: 30px;"></textarea>
                     </p>
                  </div>
                  <div>
                     <p>
...
<script>
   ...
   document.addEventListener('click', function(event) {
    ...
    loadMoreButton.addEventListener('click', function() {
        const items = root.querySelectorAll('.moreview');
    ...
    function addComment() {
      ...
      // 댓글이 추가될 때마다 visibleCount를 증가시킴
       visibleCount++
    ...
    function deleteComment() {
        ...
        // 댓글이 삭제될 때마다 visibleCount를 감소시킴
       visibleCount--;
